...
public class Action {
    ...
    public boolean postControlAction() {
        ...
        if (ctrlRes.isSuccessful() == false) {
            Log.e("postControlAction", "response failed, returning false");
            return false;
        }
        ...
        try {
            ...
            Log.e("postControlAction", "Action succesfully delivered but invalid arguments returned. " + ex.getMessage());
