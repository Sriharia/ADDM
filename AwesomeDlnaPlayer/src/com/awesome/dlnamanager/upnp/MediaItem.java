...
public class MediaItem {
	...
	public boolean equals(Object o) {
		...
		if (o == null || o.getClass() != this.getClass())
			return false;
		MediaItem v = (MediaItem) o;
		if (null != resInfo.res && null == v.resInfo.res)
			return resInfo.res.equals(v.resInfo.res);
		return false;
	}

	public MediaItem(String stringid, String title, String artist,
			String album, String objectClass) {
