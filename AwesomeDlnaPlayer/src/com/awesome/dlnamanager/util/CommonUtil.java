...
public class CommonUtil {
    ...
    public static boolean aquireMultiLock(Context context) {
        WifiManager wifiManager = (WifiManager) context
                .getSystemService(Context.WIFI_SERVICE);
        MulticastLock multicastLock = wifiManager
                .createMulticastLock("DLNAPlayer");
    ...
    public static float getSysNetworkDownloadSpeed() {
        ...
        if (timeinterval > 0)
            m_fSysNetowrkLastSpeed = (float) bytes * 1.0f
                    / (float) timeinterval;
    ...
    public static String getDeviceName() {
        ...
        try {
            ...
            manufacturer = manufacturerField.get(android.os.Build.class)
                    .toString();
        } catch (Exception e) {
