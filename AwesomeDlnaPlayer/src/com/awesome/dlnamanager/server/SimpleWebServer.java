...
public class SimpleWebServer extends NanoHTTPD {
    ...
    public SimpleWebServer(String host, int port, List<File> wwwroots,
                           boolean quiet) {
        super(host, port);
        this.quiet = quiet;
    ...
    public static void main(String[] args) {
        ...
        ServiceLoader<WebServerPluginInfo> serviceLoader = ServiceLoader
                .load(WebServerPluginInfo.class);
        ...
        ServerRunner.executeInstance(new SimpleWebServer(host, port, rootDirs,
                quiet));
    }
    ...
    public Response serve(IHTTPSession session) {
        ...
        if (!quiet) {
            Log.e("SWS", session.getMethod() + " '" + uri + "' ");
    ...
    private Response respond(Map<String, String> headers, IHTTPSession session,
        ...
        Log.e("SWS", "SimpleWebServer.respond() - uri is: " + uri);
        ...
        if (!canServeUri) {
            Log.e("SWS", "cannot serve uri, returnig..");
        ...
        if (plugin != null) {
            response = plugin.serveFile(uri, headers, session, f,
                    mimeTypeForFile);
